      ...
      {stage >= 2 && (
        ...
        >
          ...
          <div className="px-3 py-0.5">
            <div className="grid grid-cols-[1fr_36px_28px_36px] gap-2 text-[9px] uppercase tracking-wider text-gray-400 font-semibold py-1.5 border-b border-gray-100">
              <span>Keyword</span>
            ...
            {keywords.map((kw, i) => (
              <motion.div
                ...
                className="grid grid-cols-[1fr_36px_28px_36px] gap-2 py-1.5 border-b border-gray-50 last:border-0 text-[11px]"
              >
