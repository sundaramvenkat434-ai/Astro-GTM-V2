...
export function ArticlesGrid({ articles, totalCount, siteName, publicDomain, logoUrl, headerLogoHeight = 32, footerLogoHeight = 24, poweredByEnabled = true, poweredByHeight = 20, poweredByOpacity = 60 }: Props) {
