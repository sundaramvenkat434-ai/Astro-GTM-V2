  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] flex flex-col">
      ...
      >
        ...
        <div className={`relative max-w-3xl mx-auto px-6 sm:px-8 lg:px-10 pt-14 pb-14 sm:pt-31 sm:pb-31 lg:pt-31 lg:pb-31 text-center transition-all duration-700 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
