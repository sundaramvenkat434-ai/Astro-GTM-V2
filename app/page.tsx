  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] flex flex-col">
      ...
      >
        ...
        <div className={`relative max-w-3xl mx-auto px-6 sm:px-8 lg:px-10 pt-14 pb-14 sm:pt-22 sm:pb-22 lg:pt-26 lg:pb-26 text-center transition-all duration-700 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
