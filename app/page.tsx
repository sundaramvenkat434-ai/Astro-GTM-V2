  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] flex flex-col">
      ...
      >
        ...
        <div className={`relative max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 pt-10 pb-10 sm:pt-20 sm:pb-20 text-center transition-all duration-700 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          ...
          <div className="inline-flex items-center gap-2 mb-4 sm:mb-6 px-3.5 py-1 rounded-full border border-white/[0.08] bg-white/[0.04]">
            ...
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400 leading-none">
              20+ New Tools Added
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-[1.75rem] sm:text-[3.2rem] lg:text-[3.8rem] font-extrabold text-white leading-[1.1] tracking-[-0.02em] mb-3 sm:mb-5">
          ...
          {/* Sub-headline */}
          <p className="text-[13px] sm:text-[17px] font-normal text-slate-400 leading-[1.6] max-w-[520px] mx-auto mb-6 sm:mb-9 tracking-[0.005em]">
            Discover top, tested{' '}
          ...
          {/* CTAs */}
          <div className="flex flex-row items-center justify-center gap-2.5 sm:gap-3 mb-6 sm:mb-9">
            {/* Browse Top Tools */}
            <button
              onClick={() => document.getElementById('tools-section')?.scrollIntoView({ behavior: 'smooth' })}
              className="group relative overflow-hidden inline-flex items-center gap-2 px-5 py-2.5 sm:px-7 sm:py-3.5 rounded-xl font-semibold text-[13px] sm:text-[14.5px] text-white transition-all duration-200 hover:scale-[1.03] active:scale-[0.97]"
              style={{
            ...
            <button
              ...
              className="relative inline-flex items-center gap-2 px-5 py-2.5 sm:px-7 sm:py-3.5 rounded-xl font-semibold text-[13px] sm:text-[14.5px] transition-all duration-300 overflow-hidden hover:scale-[1.03] active:scale-[0.97]"
              style={{
